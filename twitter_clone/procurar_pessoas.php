	      ...
	      <div class="container">
	        ...
	        <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="home.php">Voltar pra home</a></li>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <form id="form_procurar_pessoas" class="input-group">
                            ...
                            maxlength="140" id="nome_pessoa" name="nome_pessoa">
                            <span class="input-group-btn">
                                <button class="btn btn-default" type="button" id="btn_procurar_pessoa" name="btn_procurar_pessoa">
                                    Procurar
                                </button>
                            </span>
                        </form>
